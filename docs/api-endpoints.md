...
#### **Overpass API (OpenStreetMap)** ⭐ *Default Service*
...
#### **Groq Cloud (Llama 70B)** ⭐ *Default Service*
...
### ⚠️ Data Shared with External Services
...
### Request Flow
```
User Action → App Component → API Service → External API
                                    ↓
                        Response Processing
                                    ↓
...
- Graceful fallbacks (e.g., Photon → Open-Meteo for geocoding)
