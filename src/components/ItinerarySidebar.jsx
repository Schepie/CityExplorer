            ...
            {!isOpen && (
                <>
                    ...
                    <button
                        ...
                        className="absolute top-4 left-0 -translate-x-1/2 z-[400] text-white p-3 rounded-full shadow-lg border border-white/10 transition-all opacity-50 hover:opacity-100 hover:translate-x-0"
                    ...
                    <button
                        ...
                        className="absolute bottom-4 left-0 -translate-x-1/2 z-[400] text-white p-3 rounded-full shadow-lg border border-white/10 transition-all opacity-50 hover:opacity-100 hover:translate-x-0"
